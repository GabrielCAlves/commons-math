...
public class EnumeratedIntegerDistributionTest {
    ...
    public void testExceptions() {
        ...
        // int[] points = new int[]{-2, -1, 0, 1, 2, 3, 4, 5, 6, 7, 8};
        results = new double[] { 0, 0.2, 0.2, 0.2, 0.2, 0.7, 0.7, 0.7, 0.7, 1.0, 1.0 };
        for (int p = 0; p < points.length; p++) {
    ...
    public void testSample() {
        final int n = 1000000;
        final DiscreteDistribution.Sampler sampler = testDistribution
                .createSampler(RandomSource.XO_RO_SHI_RO_128_PP.create());
